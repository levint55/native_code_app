...
@Override
  ...
  super.configureFlutterEngine(flutterEngine);
    new MethodChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), "myapp.flutter.dev/channel_example")
                  ...
                  if (call.method.equals("getBatteryLevel")) {
                    ...
                    if (batteryLevel != -1) {
                      ...
                      if (androidVersion != -1) {
                        ...
                        result.error("UNAVAILABLE", "Could not fetch android version.", null);
                      }
                  } else {
  ...
  private int getAndroidVersion(){
      ...
      androidVersion = VERSION.SDK_INT;
